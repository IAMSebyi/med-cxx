...
med::layers::Bottleneck::Bottleneck(int inPlanes, int planes, int stride, torch::nn::Sequential downsample_)
...
torch::Tensor med::layers::Bottleneck::forward(torch::Tensor x) {
